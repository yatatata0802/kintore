      ...
      <div className="flex items-center justify-between gap-4 mb-4 z-20">
        ...
        <div className="flex items-center gap-2">
          ...
          >
            ...
            <span>{isCopiedRemaining ? 'コピー完了！' : '残り回数コピー'}</span>
          </button>

          <button
            id="overlay-copy-current-btn"
            onClick={handleCopyCurrent}
            className={`px-3 py-1.5 rounded-xl border transition-all flex items-center gap-1.5 text-xs font-bold ${
              isCopiedCurrent
                ? 'bg-emerald-500/20 text-emerald-300 border-emerald-400/50'
                : 'bg-black/50 hover:bg-black/70 text-emerald-300 border-white/20 hover:text-emerald-200'
            }`}
          ...
          >
            ...
            <span>{isCopiedCurrent ? 'コピー完了！' : '【済】実績コピー'}</span>
          </button>
